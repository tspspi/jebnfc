...
public class KeepParser_metaidentifier_0 extends ParserElementTerminal {
	public KeepParser_metaidentifier_0 (ParserElement parent) {
		super(parent, "metaidentifier_0", 1, 1);
	...
	public ParserElement factory(ParserElement parent) { return new KeepParser_metaidentifier_0(parent); }
	public String toString() { return "metaidentifier_0"; }
}
