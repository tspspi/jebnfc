...
public class EbnfElement_integer_28 extends ParserElementTerminal {
	public EbnfElement_integer_28 (ParserElement parent) {
		super(parent, "integer_28", 1, 1);
	...
	public ParserElement factory(ParserElement parent) { return new EbnfElement_integer_28(parent); }
	public String toString() { return "integer_28"; }
}
