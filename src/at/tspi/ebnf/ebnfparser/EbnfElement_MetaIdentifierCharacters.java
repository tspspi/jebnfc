...
public class EbnfElement_MetaIdentifierCharacters extends ParserElementTerminal {
	public EbnfElement_MetaIdentifierCharacters(ParserElement parent) {
		super(parent, "MetaIdentifierCharacters", 0, 0);
	...
	public ParserElement factory(ParserElement parent) { return new EbnfElement_MetaIdentifierCharacters(parent); }
	public String toString() { return "MetaIdentifierCharacters"; }
}