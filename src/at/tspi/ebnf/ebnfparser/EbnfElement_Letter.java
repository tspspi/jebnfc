...
public class EbnfElement_Letter extends ParserElementTerminal {
	public EbnfElement_Letter(ParserElement parent) {
		super(parent, "Letter", 1, 1);
	...
	public ParserElement factory(ParserElement parent) { return new EbnfElement_Letter(parent); }
